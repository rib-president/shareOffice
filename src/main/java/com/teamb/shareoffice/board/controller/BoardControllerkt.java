...
public class BoardControllerkt {
	...
	public String freeBoardPage(
		...
		ArrayList<HashMap<String, Object>> freeBoardList = boardServicekt.getFreeBoardList(pageNum, searchOption, searchStr);
		
		int count = boardServicekt.getFreeBoardCount(searchOption, searchStr);
		...
		if(searchStr != null) {
			...
			additionalParam += "&searchStr=" + searchStr;
		}
