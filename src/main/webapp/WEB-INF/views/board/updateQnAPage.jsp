	...
	<div class="col" style="margin-left: 1rem; margin-right: 1rem;">
		...
		<div class="row">
			...
			<div class="col text-fs-13" style="text-align: right; margin-bottom: 0.3rem;">
				No. ${data.QnAVo.qna_no}
			</div>
				<div class="row">
					<div class="col">
						<input type="text" class="form-control text-fs-20" name="qna_title" value="${data.QnAVo.qna_title }">
					</div>	
				</div>
				
				<div class="row mt-2">
					<div class="col">
						<input type="radio" name="qna_screct" checked value="Y">
							<span>공개</span>&nbsp&nbsp&nbsp&nbsp
						<input type="radio" name="qna_screct" value="N" >
							<span>비공개</span>
					</div>				
				</div>	
				...
				<div class="row">
					<div class="col">
						<textarea class="form-control text-fs-16" rows="5" name="qna_content">${data.QnAVo.qna_content }</textarea>
					</div>
				</div>
